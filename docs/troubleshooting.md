...
- `embedding_deployment_capacity_thousands = 30` means 30,000 TPM for the embedding deployment. Lower it if the selected Azure OpenAI or Foundry region cannot allocate that much embedding quota.
